...
const Books = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.ul`
	display: flex;
	flex-direction: row;
	flex-wrap: wrap;
...
`;
const Price = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.span`
	font-size: 1.25rem;
`;
...
const indexPage = () => {
  ...
  const getBooks = () => {
    return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(`https://booksontap.azurewebsites.net/api/Books`);
  };
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    __self: undefined
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_layout_container__WEBPACK_IMPORTED_MODULE_5__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 86
    },
    __self: undefined
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Books, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 87
    },
    __self: undefined
  }, books.length !== 0 ? books.results.map(book => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    key: book.id,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 90
    ...
    __self: undefined
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(BookLink, {
    slug: book.id,
    content: book,
    __source: {
      fileName: _jsxFileName,
    ...
    __self: undefined
  }, toLocalCurrency(book.price)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 97
    },
    __self: undefined
  }, book.title), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 98
    },
    __self: undefined
  }, `by ${book.author.firstName} ${book.author.lastName}`)))) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 105
    },
...
module.exports = __webpack_require__(/*! /Users/jacob/Development/booksontap/pages/index.tsx */"./pages/index.tsx");
